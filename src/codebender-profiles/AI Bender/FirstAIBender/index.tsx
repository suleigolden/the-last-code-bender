...
export default function FirstAIBenderProfile() {
  return (
    <div className="flex flex-col font-mono text-sm rounded-lg border border-border overflow-hidden">
      ...
      <div className="flex items-center bg-ide-tab border-b border-border">
        <div className="flex items-center px-4 py-2.5 text-xs font-mono bg-ide-tab-active border-t-2 border-t-syntax-variable border-r border-border text-foreground">
          README.md
        </div>
      </div>
        ...
        <aside className="hidden lg:flex flex-col w-48 bg-file-tree-bg border-r border-border shrink-0">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5 px-3 py-1 text-folder-icon">
              <span>▾</span>
              <span className="text-xs">FirstAIBender</span>
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="mt-3 space-y-1.5">
              <div>
                ...
                <span className="text-syntax-keyword">&quot;FirstAIBender&quot;</span>
              </div>
              <div>
                <span className="text-syntax-keyword">const </span>
            ...
            <div className="mt-4 text-syntax-comment space-y-0.5">
              ...
              <p>{' * CodeBenders/AI Bender/FirstAIBender/'}</p>
      ...
      <div className="bg-ide-statusbar px-4 py-1 flex items-center gap-3 font-mono text-xs shrink-0">
        <span className="text-syntax-variable">UNCLAIMED</span>
        <span className="text-muted-foreground">|</span>
        <span className="text-muted-foreground">FirstAIBender</span>
        <span className="text-muted-foreground">|</span>
        <span className="text-muted-foreground">AI Bender</span>
      </div>
    </div>
  );
}
